...
from inversions.unet_based.gnri import (SDInversionPipeline, SDXLInversionPipeline, CustomDDIMInversionScheduler,
...
def main():
    ...
    path_tar = os.path.join(path_tar, "{}_GNRI_{}_{}_{}_{}".format(args.model_type, args.spacing, args.num_inference_steps, args.trdi_window, args.guidance_scale), )
    os.makedirs(path_tar, exist_ok=True)
    ...
    for i, datum in enumerate(data):
        ...
        print(f"[GNRI] PSNR: {psnr_score:.2f}, SSIM: {ssim_score:.4f}, LPIPS: {lpips_score:.4f}")
