...
from inversions.unet_based.npi import (SDInversionPipeline, SDXLInversionPipeline, CustomDDIMInversionScheduler, 
...
def main():
    ...
    path_tar = os.path.join(path_tar, "{}_NPI_{}_{}_{}_{}".format(args.model_type, args.spacing, args.num_inference_steps, args.trdi_window, args.guidance_scale), )
    os.makedirs(path_tar, exist_ok=True)
