...
# CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES /home/sunshangquan/anaconda3/envs/diffusion-inversion/bin/python exp/unet_based/ddim_recon.py \
# --spacing 1.0 --num_inference_steps 50 --model_type SD15 --trdi_window 0; 

for model in SD15; do
    for spacing in 1.05; do
        for window in 0 8 10; do
            CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES /home/sunshangquan/anaconda3/envs/diffusion-inversion/bin/python exp/unet_based/ddim_recon.py \
